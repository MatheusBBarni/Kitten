...
/** The package that owns the runtime, launcher, and compiled artifacts. */
export const PACKAGE_ROOT = dirname(dirname(fileURLToPath(import.meta.url)))

/** The entry point compiled into each binary, resolved from the owning package. */
export const ENTRYPOINT = join(PACKAGE_ROOT, "src", "index.ts")
 ...
 */
export const TREE_SITTER_WORKER_ENTRYPOINT = createRequire(import.meta.url).resolve(
