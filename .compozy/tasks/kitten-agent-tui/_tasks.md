...
|---|-------|--------|------------|--------------|
| 01 | Project scaffold and tooling | pending | medium | — |
| 02 | Domain core types and session reducer | pending | medium | task_01 |
| 03 | Agent adapter layer and ACP translation | pending | high | task_01, task_02 |
| 04 | Config loading and agent readiness | pending | medium | task_03 |
| 05 | Reactive app store | pending | medium | task_02, task_03 |
| 06 | Deterministic hand-off bundle assembler and secret redactor | pending | medium | task_02 |
